# Generated by Django 3.1.7 on 2021-05-10 12:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.CharField(blank=True, default='npQb9m5D7jZH1jAuTA9ZYMtB', max_length=24, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('actor_id', models.CharField(blank=True, default='WkUaFEHH8ECbREASchmuWyJVqyGDhUa2', max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('producer_id', models.CharField(blank=True, default='MKrgz7FgsY2Q7AA22NteSZeji3Pe9m19', max_length=32, null=True)),
                ('name', models.CharField(max_length=100)),
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], max_length=50, null=True)),
                ('photo', models.ImageField(default='avatars/default/man.png', upload_to='avatars/')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('writer_id', models.CharField(blank=True, default='x2wJ9GruHjWUbzvWVvjHf5V9xNQDk1y1', max_length=32, null=True)),
                ('name', models.CharField(max_length=100)),
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], max_length=50, null=True)),
                ('photo', models.ImageField(default='avatars/default/man.png', upload_to='avatars/')),
            ],
