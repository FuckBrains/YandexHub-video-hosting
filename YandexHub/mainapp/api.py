            ...
            if channel:
                ...
                if request.user != channel:
                    ...
                    if subscribe.count() > 0:
                        ...
                        subscribe.delete()
                        return Response(
                            {'data': {'subscribe': 0}, 'message': 'Subscription removed 🤡', 'status': 'ok'},
                    ...
                    return Response({'data': {}, 'message': 'Unable to subscribe to yourself 😬', 'status': 'err'},
                                    status=status.HTTP_200_OK)
            else:
        ...
        if 'user_id' in request.data:
            ...
            if channel:
                ...
                if notification.count() > 0:
                    ...
                    notification.delete()
                    return Response(
                        {'data': {'notification': 0}, 'message': 'Notifications turned off for this channel 😬',
                    ...
                    return Response(
                        {'data': {'notification': 1}, 'message': 'You’ll get all notifications 😃', 'status': 'ok'},
                        status=status.HTTP_200_OK)
            ...
            if video.count() > 0:
                ...
                if like.count() == 0 and dislike.count() == 0:
                    ...
                    if like:
                        ...
                        video.creator.save()
                    return Response({'data': {'like': 1, 'dislike': 0,
                                              'stats': {'likes': brief_likes_format(video.likes),
                                                        'dislikes': brief_likes_format(video.dislikes)}},
                                     'message': 'Added to Liked videos 👍', 'status': 'ok'}, status=status.HTTP_200_OK)
                    ...
                    video.creator.all_likes -= 1
                    video.creator.save()
                    return Response({'data': {'like': 0, 'dislike': 0,
                                              'stats': {'likes': brief_likes_format(video.likes),
                                                        'dislikes': brief_likes_format(video.dislikes)}},
                                     'message': 'Removed from Liked videos 👀', 'status': 'ok'},
                                    status=status.HTTP_200_OK)
            ...
            if video.count() > 0:
                ...
                if like.count() == 0 and dislike.count() == 0:
                    ...
                    if dislike:
                        ...
                        video.creator.all_dislikes += 1
                        video.creator.save()
                    return Response({'data': {'like': 0, 'dislike': 1,
                                              'stats': {'likes': brief_likes_format(video.likes),
                                                        'dislikes': brief_likes_format(video.dislikes)}},
                                     'message': 'You dislike this video 👎', 'status': 'ok'}, status=status.HTTP_200_OK)
                    ...
                    return Response({'data': {'like': 0, 'dislike': 0,
                                              'stats': {'likes': brief_likes_format(video.likes),
                                                        'dislikes': brief_likes_format(video.dislikes)}},
                                     'message': 'Dislike removed 😎', 'status': 'ok'}, status=status.HTTP_200_OK)
            ...
            if video.count() > 0:
                ...
                if len(text) < 500:
                    if text.replace(' ', '') != '' and text is not None:
                        ...
                        today = date.today()
                        if Comment.objects.filter(commented_video=video, creator=request.user,
                                                  date_created_without_time=today).count() < 10:
                            Comment.objects.create(commented_video=video, creator=request.user,
                                                   comment_id=generate_id(32), comment_text=text)
                            video.comments += 1
                            video.save()
                            ...
                            return Response(
                                {'data': {}, 'message': 'You have exceeded the comment limit for one video today 😥',
                                 'status': 'err'}, status=status.HTTP_200_OK)
                    else:
                        return Response(
                            {'data': {}, 'message': 'Comment cannot contain spaces or be empty 🙉', 'status': 'err'},
                            status=status.HTTP_200_OK)
                else:
            ...
            if comment.count() > 0:
                ...
                if like.count() == 0 and dislike.count() == 0:
                    ...
                    if like:
                        ...
                        comment.save()
                    return Response({'data': {'like': 1, 'dislike': 0,
                                              'stats': {'likes': brief_likes_format(comment.likes),
                                                        'dislikes': brief_likes_format(comment.dislikes)}},
                                     'message': '', 'status': 'ok'}, status=status.HTTP_200_OK)
                ...
                if comment.count() > 0:
                    ...
                    if len(text) < 500:
                        if text.replace(' ', '') != '' and text is not None:
                            ...
                            today = date.today()
                            if ReplyComment.objects.filter(reply_commented_video=video, comment_parent=comment,
                                                           creator=request.user,
                                                           date_created_without_time=today).count() < 10:
                                ReplyComment.objects.create(reply_commented_video=video, comment_parent=comment,
                                                            creator=request.user, reply_comment_id=generate_id(32),
                                                            comment_text=text)
                                comment.replies += 1
                                comment.save()
                                video.comments += 1
                            ...
                            return Response({'data': {}, 'message': 'Comment cannot contain spaces or be empty 🙉',
                                             'status': 'err'}, status=status.HTTP_200_OK)
                    else:
                        return Response(
                            {'data': {}, 'message': 'Maximum text length 500 characters 🥴', 'status': 'err'},
                            status=status.HTTP_200_OK)
                else:
                    return Response({'data': {}, 'message': 'Comment not found', 'status': 'err'},
                                    status=status.HTTP_200_OK)
    ...
    def post(self, request):
        if 'reply_comment_id' in request.data:
            ...
            if comment.count() > 0:
                ...
                return Response({'data': {}, 'message': 'Reply comment not found', 'status': 'err'},
                                status=status.HTTP_200_OK)
        else:
            return Response({'data': {}, 'status': 'err'}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def post(self, request):
        if 'reply_comment_id' in request.data:
            ...
            if comment.count() > 0:
                ...
                if like.count() == 0 and dislike.count() == 0:
                    dislike = ReplyCommentDislike.objects.create(disliked_reply_comment=comment,
            ...
            if video.count() > 0:
                ...
                if request.user == video.creator:
                    ...
                    for i in range(10):
                        ...
                        reply_comments = ReplyComment.objects.filter(reply_commented_video=video,
                    ...
                    return Response({'data': {'views': views_stats, 'comments': comments_stats, 'likes': likes_stats,
                                              'dislikes': dislikes_stats}, 'message': '', 'status': 'ok'},
                                    status=status.HTTP_200_OK)
                else:
                    return Response({'data': {},
            ...
            if article.count() > 0:
                ...
                if request.user == article.creator:
                    ...
                    for i in range(10):
                        ...
                        dislikes = ArticleDislike.objects.filter(disliked_article=article,
                                                                 date_created_without_time__gt=(day))
                    ...
                    return Response(
                        {'data': {'likes': likes_stats, 'dislikes': dislikes_stats}, 'message': '', 'status': 'ok'},
                        status=status.HTTP_200_OK)
                else:
                    return Response({'data': {},
                                     'message': 'You do not have permission to view statistics because you are not its author',
        ...
        if 'track_id' in request.data:
            ...
            if track.count() > 0:
                ...
                if request.user == track.creator:
                    ...
                    for i in range(10):
                        day = today - timedelta(days=i)
                        auditions = TrackListenModel.objects.filter(listened_track=track,
                                                                    date_created_without_time__gt=(day))

                        if day >= track.date_created_without_time:
                            auditions_stats[str(day)] = track.auditions - auditions.count()

                    return Response({'data': {'auditions': auditions_stats}, 'message': '', 'status': 'ok'},
                                    status=status.HTTP_200_OK)
                else:
                    return Response({'data': {},
                                     'message': 'You do not have permission to view statistics because you are not its author',
            ...
            if film.count() > 0:
                ...
                if like.count() == 0 and dislike.count() == 0:
                    ...
                    if like:
                        ...
                        film.save()
                    return Response({'data': {'like': 1, 'dislike': 0,
                                              'stats': {'likes': brief_likes_format(film.likes),
                                                        'dislikes': brief_likes_format(film.dislikes)}},
                                     'message': 'Your liked this film 🧡', 'status': 'ok'}, status=status.HTTP_200_OK)
                    ...
                    return Response({'data': {'like': 0, 'dislike': 0,
                                              'stats': {'likes': brief_likes_format(film.likes),
                                                        'dislikes': brief_likes_format(film.dislikes)}},
                                     'message': 'Like removed 🧸', 'status': 'ok'}, status=status.HTTP_200_OK)
            ...
            if film.count() > 0:
                ...
                if like.count() == 0 and dislike.count() == 0:
                    ...
                    return Response({'data': {'like': 0, 'dislike': 1,
                                              'stats': {'likes': brief_likes_format(film.likes),
                                                        'dislikes': brief_likes_format(film.dislikes)}},
                                     'message': 'Your disliked this film 💔', 'status': 'ok'},
                                    status=status.HTTP_200_OK)
        ...
        if 'film_id' in request.data:
            ...
            if film.count() > 0:
                ...
                if BuyFilm.objects.filter(buy_user=request.user, buy_film=film).count() == 0:
                    ...
                    return Response({'data': {}, 'message': 'You have already bought this film', 'status': 'ok'},
                                    status=status.HTTP_200_OK)
            else:
                return Response({'data': {}, 'message': 'Film not found', 'status': 'err'}, status=status.HTTP_200_OK)
        else:
        ...
        if 'article_id' in request.data:
            ...
            if article.count() > 0:
                ...
                if like.count() == 0 and dislike.count() == 0:
                    ...
                    return Response({'data': {'like': 1, 'dislike': 0,
                                              'stats': {'likes': brief_likes_format(article.likes),
                                                        'dislikes': brief_likes_format(article.dislikes)}},
                                     'message': 'You like this article 👍', 'status': 'ok'}, status=status.HTTP_200_OK)
            ...
            if article.count() > 0:
                ...
                if like.count() == 0 and dislike.count() == 0:
                    ...
                    return Response({'data': {'like': 0, 'dislike': 1,
                                              'stats': {'likes': brief_likes_format(article.likes),
                                                        'dislikes': brief_likes_format(article.dislikes)}},
                                     'message': 'You dislike this article 👎', 'status': 'ok'},
                                    status=status.HTTP_200_OK)
...
class VideosApi(APIView):
    ...
    def get(self, request):
        ...
        if user_videos:
            ...
            return Response({'data': {}, 'message': 'Videos not found', 'status': 'err'},
        ...
        if liked_videos:
            ...
            for video in liked_videos:
                try:
                    ...
                    video_info['media'] = {'video': str(video.liked_video.video),
            ...
            return Response({'data': {'videos': ''}, 'message': 'Liked videos not found', 'status': 'err'},
                            status=status.HTTP_400_BAD_REQUEST)
        ...
        if disliked_videos:
            ...
            for video in disliked_videos:
                try:
                    ...
                    video_info['creator'] = {'user_id': video.disliked_user.user_id,
                                             'username': video.disliked_user.username}
                    video_info['media'] = {'video': str(video.disliked_video.video),
            ...
            return Response({'data': {'videos': ''}, 'message': 'Disliked videos not found', 'status': 'err'},
                            status=status.HTTP_400_BAD_REQUEST)
        ...
        if saved_videos:
            ...
            for video in saved_videos:
                try:
                    ...
                    video_info['media'] = {'video': str(video.saved_video.video),
            ...
            return Response({'data': {'videos': ''}, 'message': 'Saved videos not found', 'status': 'err'},
                            status=status.HTTP_400_BAD_REQUEST)
    ...
    def post(self, request):
        if 'video' in request.data and 'banner' in request.data and 'title' in request.data and 'description' in request.data:
            ...
            if video.size > MAX_VIDEO_SIZE:
                return Response(
                    {'data': {}, 'message': 'The size of the video should not exceed 200 MB.', 'status': 'OK'})

            banner = request.data.get('banner')
            if banner.size > MAX_IMAGE_SIZE:
                return Response(
                    {'data': {}, 'message': 'The size of the photo should not exceed 7.5 MB.', 'status': 'OK'})

            # maximum 5 videos per day (one user)
            today = date.today()
            if Video.objects.filter(creator=request.user, date_created_without_time=today).count() < 5:
                data = {'creator': self.request.user.id, 'title': request.data.get('title'),
                        'description': request.data.get('description'), 'video': video, 'video_banner': banner}
                ...
                return Response({'data': {'id': queryset.video_id}, 'message': message, 'status': 'OK'},
                                status=status.HTTP_200_OK)
            else:
                return Response(
                    {'data': {}, 'message': 'You have exceeded the videos limit for one day today 😥', 'status': 'err'},
                    status=status.HTTP_200_OK)
        else:
            return Response({'data': {}, 'status': 'err'}, status=status.HTTP_400_BAD_REQUEST)
...
class FilmsApi(APIView):
    ...
    def get(self, request):
        ...
        if site_films:
            ...
            return Response({'data': {}, 'message': 'Films not found', 'status': 'err'},
                            status=status.HTTP_400_BAD_REQUEST)
...
class FilmApi(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if film:
            ...
            return Response({'data': {}, 'message': 'Film not found', 'status': 'err'},
                            status=status.HTTP_400_BAD_REQUEST)
...
class LikedFilmsApi(APIView):
    ...
    def get(self, request):
        ...
        if liked_films:
            ...
            return Response({'data': {}, 'message': 'Liked films not found', 'status': 'err'},
                            status=status.HTTP_400_BAD_REQUEST)
...
class DislikedFilmsApi(APIView):
    ...
    def get(self, request):
        ...
        if disliked_films:
            ...
            return Response({'data': {}, 'message': 'Disliked films not found', 'status': 'err'},
                            status=status.HTTP_400_BAD_REQUEST)
...
class PurchasedFilmsApi(APIView):
    ...
    def get(self, request):
        ...
        if durchased_films:
            ...
            return Response({'data': {}, 'message': 'Purchased films not found', 'status': 'err'},
                            status=status.HTTP_400_BAD_REQUEST)
    ...
    def get(self, request, *args, **kwargs):
        ...
        if film:
            if BuyFilm.objects.filter(buy_user=request.user, buy_film=film[0]):
                ...
                return Response({'data': {}, 'message': 'You did not buy this film', 'status': 'err'},
...
class ArticleApi(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return Response({'data': {'article': article_info}, 'message': message, 'status': 'ok'},
                        status=status.HTTP_200_OK)
...
class CreateArticleApi(APIView):
    ...
    def post(self, request):
        if 'text' in request.data:
            text = request.data.get('text')
            if len(text) > 1000000:
                return Response({'data': {}, 'message': 'Maximum text length 1000000 characters.', 'status': 'err'},
                                status=status.HTTP_200_OK)
            ...
            if Article.objects.filter(creator=request.user, date_created_without_time=today).count() < 10:
                ...
                return Response({'data': {'id': queryset.article_id}, 'message': message, 'status': 'OK'},
                                status=status.HTTP_200_OK)
            else:
                return Response({'data': {}, 'message': 'You have exceeded the articles limit for one day today 😥',
                                 'status': 'err'}, status=status.HTTP_200_OK)
        else:
            return Response({'data': {}, 'status': 'err'}, status=status.HTTP_400_BAD_REQUEST)
...
class TracksApi(APIView):
    ...
    def get(self, request):
        ...
        if user_tracks:
            ...
            return Response({'data': {}, 'message': 'Tracks not found', 'status': 'err'},
                            status=status.HTTP_400_BAD_REQUEST)
