# Generated by Django 3.1.7 on 2021-05-18 12:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('actor_id', models.CharField(blank=True, default='A7fBQAg2L4FSAxRmDWYV2cE26x6pUXRX', max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('producer_id', models.CharField(blank=True, default='YFFD5y7hrG4MmQPaGRLxNcQZurMdJUvF', max_length=32, null=True)),
                ('name', models.CharField(max_length=100)),
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], max_length=50, null=True)),
                ('photo', models.ImageField(default='avatars/default/man.png', upload_to='avatars/')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('writer_id', models.CharField(blank=True, default='u4Y4ibNzSaRi94UTkW96TfG6sgmcMeWi', max_length=32, null=True)),
                ('name', models.CharField(max_length=100)),
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], max_length=50, null=True)),
                ('photo', models.ImageField(default='avatars/default/man.png', upload_to='avatars/')),
            ],
